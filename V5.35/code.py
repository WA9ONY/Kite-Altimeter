...
min_airflow = 16.2 			# 16.2 mph is max for FS3000-1005 sensor
...
def check_relay_status():
    # When the reedrelay closes, D4 is connected to ground and reads low (False).
